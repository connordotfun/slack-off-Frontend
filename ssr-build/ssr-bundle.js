...
module.exports = {"card":"card__2a8Ev","image":"image__cf-QY","message":"message__25SXm","pin-text":"pin-text__1ESHW","pinText":"pin-text__1ESHW","vote-button":"vote-button__1AZp2","voteButton":"vote-button__1AZp2"};
...
// EXTERNAL MODULE: ../node_modules/slackdown/src/slackdown.js
var slackdown = __webpack_require__("VuB8");
var slackdown_default = /*#__PURE__*/__webpack_require__.n(slackdown);
...
const Card = (_a) => {
    var { pin, submitVote } = _a, props = __rest(_a, ["pin", "submitVote"]);
    return (Object(preact_min["h"])("div", { className: card_style["card"] },
        pin.file !== '' ? Object(preact_min["h"])("img", { src: pin.file, class: card_style["image"] }) : null,
        pin.text !== '' ? Object(preact_min["h"])("div", { class: card_style["message"] },
            Object(preact_min["h"])("span", { class: card_style["pinText"], dangerouslySetInnerHTML: { __html: slackdown["parse"](pin.text) } }),
            ...
            Object(preact_min["h"])("span", null,
                ...
                pin.author,
                ", in ",
                Object(preact_min["h"])("em", null, pin.channel))) :
            Object(preact_min["h"])("div", { class: card_style["message"] },
                Object(preact_min["h"])("span", null,
                    "\u2013",
                    pin.author,
                    ", in ",
                    Object(preact_min["h"])("em", null, pin.channel))),
        Object(preact_min["h"])("div", { class: card_style["voteButton"], onClick: submitVote }, "VOTE")));
};
/* harmony default export */ var card = (Card);

// EXTERNAL MODULE: ./routes/vote/style.css
var vote_style = __webpack_require__("LUtQ");
var vote_style_default = /*#__PURE__*/__webpack_require__.n(vote_style);

// CONCATENATED MODULE: ./routes/vote/index.tsx
...
class vote_Vote extends preact_min["Component"] {
    constructor() {
        super(...arguments);
        this.API_HOST = 'connor-dot-fun-slack-off.herokuapp.com';
    }
    ...
    render({}, { currentPairing }) {
        if (currentPairing) {
            return (Object(preact_min["h"])("div", { class: vote_style["vote"] },
                Object(preact_min["h"])("div", { className: vote_style["pairing"] },
                    Object(preact_min["h"])(card, { pin: currentPairing[0], submitVote: () => this._voteFor(0) }),
                    Object(preact_min["h"])("div", { className: vote_style["vs"] }, "VS"),
                    Object(preact_min["h"])(card, { pin: currentPairing[1], submitVote: () => this._voteFor(1) }))));
        }
        return null;
    }
    _voteFor(option) {
    ...
    _getNewPairing() {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield fetch(`//${this.API_HOST}/new_pairing`);
            const items = yield res.json();
            this.setState(() => ({ currentPairing: items }));
        });
    }
}
...
class app_App extends preact_min["Component"] {
    constructor() {
        super(...arguments);
        this.handleRoute = (e) => {
    ...
    render() {
        return (Object(preact_min["h"])("div", { id: "app" },
            Object(preact_min["h"])(preact_router_es_Router, { onChange: this.handleRoute },
                Object(preact_min["h"])(preact_router_es_Route, { path: "/", component: vote_Vote }))));
    }
}
...
// removed by extract-text-webpack-plugin
module.exports = {"vote":"vote__gi92t","vs":"vs__RFRh3","pairing":"pairing__3__zv"};
...
(function (root, factory) {
    ...
    var RE_ALPHANUMERIC = new RegExp('^\\w?$'), RE_TAG = new RegExp('<(.+?)>', 'g'), RE_BOLD = new RegExp('\\*([^\\*]+?)\\*', 'g'), RE_ITALIC = new RegExp('_([^_]+?)_', 'g'), RE_FIXED = new RegExp('`([^`]+?)`', 'g');
    var payloads = function payloads(tag, start) {
        if (!start) {
            start = 0;
        }
    ...
    var pipeSplit = function pipeSplit(payload) {
        return payload.split('|');
    };
    var tag = function tag(_tag, attributes, payload) {
        if (!payload) {
            payload = attributes;
            attributes = {};
        }
        var html = "<".concat(_tag);
        for (var attribute in attributes) {
            if (attributes.hasOwnProperty(attribute)) {
                html = html.concat(' ', attribute, '="', attributes[attribute], '"');
            }
        }
        return html.concat('>', payload, '</', _tag, '>');
    };
    var matchTag = function matchTag(match) {
    ...
    var matchBold = function matchBold(match) {
        return safeMatch(match, tag("strong", payloads(match[1])), "*");
    };
    var matchItalic = function matchItalic(match) {
        return safeMatch(match, tag("em", payloads(match[1])), "_");
    };
    var matchFixed = function matchFixed(match) {
        return safeMatch(match, tag("code", payloads(match[1])));
    };
    var notAlphanumeric = function notAlphanumeric(input) {
        return !RE_ALPHANUMERIC.test(input);
    };
    var notRepeatedChar = function notRepeatedChar(trigger, input) {
        return !trigger || trigger !== input;
    };
    var safeMatch = function safeMatch(match, tag, trigger) {
    ...
    var publicParse = function publicParse(text) {
        if (typeof text === 'string') {
            var patterns = [{ p: RE_TAG, cb: matchTag }, { p: RE_BOLD, cb: matchBold }, { p: RE_ITALIC, cb: matchItalic }, { p: RE_FIXED, cb: matchFixed }];
            for (var p = 0; p < patterns.length; p++) {
                var pattern = patterns[p], original = text, result;
